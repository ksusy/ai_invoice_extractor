"""
DS1 Final Evaluation — Kaskádová pipeline (thesis-correct design)

PRIMARY:  GPT-4.1-2025-04-14 · OCR JSON-light (NB03) · cs_en few-shot RAG n=2 (NB05)
FALLBACK: gpt-4.1-mini       · grayscale_denoise Vision standard (NB07) · text RAG n=2 (NB05)
Pole: plná sada dle GT CSV — společné (11) + komoditně specifické.
